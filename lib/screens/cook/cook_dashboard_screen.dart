...
class _CookDashboardScreenState
  ...
  Widget _buildMealsSection(User? user) {
    if (user == null) {
      return _buildMessageCard(
        ...
        message:
            'Sign in again to view your published meals.',
      );
    }
    ...
    if (user == null) {
      return _buildMessageCard(
        ...
        title: 'You are not signed in',
        message:
            'Sign in again to view your upcoming meals.',
      );
    }
        ...
        if (snapshot.hasError) {
          return _buildMessageCard(
            icon:
                Icons.error_outline_rounded,
            title:
                'Upcoming meals could not be loaded',
            message:
                snapshot.error.toString(),
          );
        }
  ...
  Widget _buildPreviousMealsSection(
    User? user,
  ) {
    if (user == null) {
      return _buildMessageCard(
        ...
        title: 'You are not signed in',
        message:
            'Sign in again to view your previous meals.',
      );
    }
      ...
      builder: (context, snapshot) {
        if (snapshot.hasError) {
          return _buildMessageCard(
            icon:
                Icons.error_outline_rounded,
            title:
                'Previous meals could not be loaded',
            message:
                snapshot.error.toString(),
          );
        }
        ...
        if (meals.isEmpty) {
          return _buildMessageCard(
            ...
            message:
                'Meals from earlier dates will appear here so you can publish them again.',
          );
        }
  ...
  Widget _buildHygieneRatingCard(
    ...
    return StreamBuilder<
      ...
      builder: (context, snapshot) {
        ...
        if (reviewStatus ==
            'approved') {
          statusText =
              'Council rating approved';
        } else if (reviewStatus ==
            'pending_review') {
          statusText =
              'Rating waiting for HomeEats review';
        } else if (
            reviewStatus ==
                    'changes_requested' ||
                reviewStatus ==
                    'rejected') {
          statusText =
              'Replacement required by HomeEats';
        } else if (
            awaitingCouncilRating) {
          statusText =
              'Awaiting council inspection/rating';
        } else {
          statusText =
              'Council rating not uploaded';
        }
    ...
    final shouldPublish =
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            'Would you like to use $mealName as the starting point for a new meal?',
          ),
          actions: [
            TextButton(
              onPressed: () {
